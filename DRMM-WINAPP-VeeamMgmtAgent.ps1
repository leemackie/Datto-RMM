...
.HISTORY
Version 1.2 - 19/03/26 - Updated for latest version of agent installer
...
$install = Start-Process "$PWD\ManagementAgent.exe" -ArgumentList "/silent", "ACCEPT_THIRDPARTY_LICENSES=""1""", "ACCEPT_EULA=""1""", "ACCEPT_REQUIRED_SOFTWARE=""1""", "ACCEPT_LICENSING_POLICY=""1"""  -Wait -PassThru
